...
export const MainContractABI = [
    ...
    },
    {
        ...
        name: 'setWhitelistStartTimeStamp',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    },
