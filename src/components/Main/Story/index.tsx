                        ...
                        <Typewriter
                            onInit={(typewriter) => {
                                typewriter
                                    ...
                                    .pauseFor(200)
                                    .pasteString(
                                        '<span>&ensp;&ensp;&ensp;&ensp;</span><span class="story-text">Outside of the spacecraft, the fierce solar storm kept speeding the spacecraft. The spacecraft became faster and faster, eventually, the spacecraft hit sub-light speed and headed toward Kepler-352b.<br /><br /><br /></span>',
                        ...
                        <Typewriter
                            onInit={(typewriter) => {
                                typewriter
                                    ...
                                    .changeDelay(1)
                                    .typeString(
                                        '<span>&ensp;&ensp;&ensp;&ensp;</span><span class="story-text">At Kepler-256b, a spacecraft landed on the planet. Meters of dust stirred up and obstructed the view. After the dust dispersed slightly, the iRIS Hogs stepped outside the spacecraft, symbolizing the new era of civilization.<br /></span>',
                                    )
                                    .callFunction((state) => {
                                        // turn off animation
                                        state.elements.cursor.style.animation = 'none';
